...
function renderHeader() {
  ...
  return `<header class="main">
      <div class="header-logo">${logoDOM}</div>
      <div arrow="keyboard_arrow_down" class="header-language">
        <form>
          ...
          <select
            ...
            v-for="todo in todos"
          >
            ${renderLanguage(wordings.language)}
          </select>
        </form>
      </div>
          ...
          <div class="button-group">
            <div class="loggedin-wrapper">
              <div class="form-checkbox">
                ...
                <label class="checkbox-support" for="loggedin-checked" />
              </div>
              <label class="loggedin-label" for="loggedin-checked">
                ${wordings.loginSavelabel}
              </label>
            </div>
 ...
 */
$(document).ready(() => {
  $("body").html(`${renderHeader()} ${renderContainer()} ${renderFooter()}`);
});
