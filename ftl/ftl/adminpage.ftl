<#assign wordings = {"languagetitle": "language", "language": ["English", "Canada"], "businessphoto": "https://admin.skavacommerce.com/admin/studio/customlib/img/loginBanner.jpg", "businessphotoalt": "Business related photo", "admintitle": "Sign In", "useremaillabel": "Your Email", "userpasswordlabel": "Your Password", "loginSavelabel": "Keep me logged in", "submitlabel": "submit", "forgotpasswordlabel": "Forgot Password?", "footerdescription": "Learn more about Skava Commerce and upcoming events at Skava.com", "footerprivacylabel": " Privacy Policy", "footercopy": "© 2019 Skava. All rights reserved."} >

  <header class="main">
      <div class="header-logo">
        <svg xmlns="http://www.w3.org/2000/svg" aria-label="skava logo" version="1.1" role="img" viewBox="0 0 141 41"
          height="26" width="90" fill="#FFF">
      ...
      <div arrow="keyboard_arrow_down" class="header-language">
        <form>
          ...
          <select name="languageselect" id="languageselect" class="custom-dropdown">
            <option value="languageItem">${wordings.language[0]}</option>
            <option value="languageItem">${wordings.language[1]}</option>
          </select>
        </form>
      </div>
      <i class="header-pancake">menu</i>
    </header>
    <div class="main-container">
      <img src="https://admin.skavacommerce.com/admin/studio/customlib/img/loginBanner.jpg"
        alt=" Business related photo" class="business-picture" />
      <div class="form-wrapper">
        <h1 class="form-title">${wordings. admintitle }</h1>
        <form class="form-signin">
          <div icontype="mail" class="form-fields">
            <label class="form-label" for="maillabel">${wordings.
                  useremaillabel
                }</label>
            <input type="text" id="maillabel" name="maillabel" />
          </div>
          <div icontype="lock" class="form-fields">
            <label class="form-label" for="passowrdlabel">${wordings.
                  userpasswordlabel
                }</label>
          ...
          <div class="button-group">
            <div class="loggedin-wrapper">
              ...
              <label class="loggedin-label" for="loggedin-checked">${wordings.
                    loginSavelabel
                  }</label>
            </div>
            <button class="form-button">${wordings. submitlabel }</button>
          </div>
          <a href="#" class="form-forgot-password" aria-label="get reset password">${wordings. forgotpasswordlabel }</a>
        </form>
      </div>
    </div>
    <footer>
